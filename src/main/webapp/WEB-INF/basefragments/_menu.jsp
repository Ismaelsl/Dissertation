		...
		<ul class="nav navbar-nav" id="menu">
			...
			<li class="dropdown"><a class="dropdown-toggle"
				data-toggle="dropdown" href="#"> <img class="imagestyle"
					alt="dissertationcoordinatoricon"
			...
			<li class="dropdown" id="lecturer"><a class="dropdown-toggle"
				data-toggle="dropdown" href="#"> <img class="imagestyle"
					alt="lecturericon" src='bootstrap/images/lecturer.png'
					onmouseover="this.src='bootstrap/images/lecturerblack.png';"
					onmouseout="this.src='bootstrap/images/lecturer.png';" /> Lecturer<span
					class="caret"></span></a>
				<ul class="dropdown-menu" id="ulmenustyle">
					<li><b><a
			...
			<li>
				<div class="container">
					<a href="${pageContext.request.contextPath}/projectlist"> <img
						class="imagestyle" alt="projectlisticon"
					...
					%>
					<img class="imagestylesmall" id="image" alt="newicon"
						src='bootstrap/images/new.png' />
					<div class="middle">
			...
			<li>
				<div class="container">
					<a href="${pageContext.request.contextPath}/checklistlist"> <img
						class="imagestyle" alt="scheduleicon"
						src='bootstrap/images/schedule.png'
			...
			<li><a href="${pageContext.request.contextPath}/contactus">
					<img class="imagestyle" alt="contactusicon"
			...
			<li><a href="${pageContext.request.contextPath}/login"> <img
					class="imagestyle" alt="loginicon" src='bootstrap/images/login.png'
					onmouseover="this.src='bootstrap/images/loginblack.png';"
					onmouseout="this.src='bootstrap/images/login.png';" /> Login
			</a></li>
			<%
			...
			<li><a href="${pageContext.request.contextPath}/logout"> <img
					class="imagestyle" alt="logouticon"
					src='bootstrap/images/logout.png'
					onmouseover="this.src='bootstrap/images/logoutblack.png';"
					onmouseout="this.src='bootstrap/images/logout.png';" /> Logout
			</a></li>
			<% }
			//general menu
			%>
